#fazer ainda o select pressure aqui
...
class DynamicUpdate():
    ...
    def on_launch(self):
        ...
        self.figure.suptitle('Flexible Lenght/Width - Local Search')
...
def print_current_best_individual(best_tuple, rankedsolutions, i):
    ...
    if(chart_on):
        ...
        if(i%150 == 0):
            if(i==150):
                plt.savefig('parcial_sp_2_2_1.png', dpi=300)
...
if chart_on:
    plt.savefig('final_sp_2_2_1.png', dpi=300)
